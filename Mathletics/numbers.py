...
class Mathletics(Scene):
    def construct(self):
        ...
        # logos
        kjssclogo=ImageMobject("kjssclogo.png").move_to(UP*3.4+LEFT*5).scale(0.5)
        mathleticslogo=ImageMobject("mathletics.png").move_to(UP*3.25+RIGHT*6).scale(0.4)

        text00=Text("The numbers, we use to count.", color=BLACK).move_to(2.6*DOWN).scale(0.85)
        text01=Text("There are different types of numbers.", color=BLACK).move_to(3.4*DOWN).scale(0.85)
        number=Text("1 2 3 4 5 6 7 8 9 ...", color=BLACK).scale(1).move_to(0.5*UP)
        text02=Text("But, Do you know numbers too have families?", color=BLACK)

        self.play(Write(title1), FadeIn(kjssclogo), FadeIn(mathleticslogo), run_time=1.5)
        self.wait(0.5)
        self.play(ReplacementTransform(title1, title2))
        # self.play(Create(line00))
        # self.play(Create(line01, run_time=1))
        self.play(Write(text00, run_time=1.25))
        self.wait(0.5)
        self.play(Write(number), run_time=1)
        self.wait(0.5)
        self.play(Write(text01), run_time=1.25)
        self.wait(1)
        ...
        text10=Text("Natural numbers", color=BLACK).move_to(1.5*DOWN)
        ...
        text11=Text("Whole Numbers", color=BLACK).move_to(1.5*DOWN)
        ...
        text12=Text("Intergers", color=BLACK).move_to(1.5*DOWN)
        ...
        text13=Text("Rational Numbers", color=BLACK).move_to(1.5*DOWN)
        ...
        text15=Text("Real numbers", color=BLACK).move_to(1.5*DOWN)
        ...
        text16=Text("Complex numbers", color=BLACK).move_to(1.5*DOWN)
        ...
        self.wait(1)
        groupt=VGroup(title2, naturals, wholes, integers, reals, imaginarys, imaginaryn, cdot_label)
        # groupp=VGroup(kjssclogo, mathleticslogo)
        self.play(
            Unwrite(groupt),
            Uncreate(axesc),
            FadeOut(kjssclogo),
            FadeOut(mathleticslogo)
        )